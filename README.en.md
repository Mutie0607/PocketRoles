...
| `about`, `info`, `説明` | What the mod does (v0.5.2). In an unregistered lobby two lines: "What the mod does in this room (no roles): welcome and guide lines, auto-translation of foreign-language chat, the post-game result list (leavers included), keeping the room from timing out" and "The game itself is normal Among Us: no roles, no special rules"; in a registered lobby a one-line note about the role mod |
